...
<div class="btn">
  ...
  <?php if (function_exists('wpfp_link') && !is_user_logged_in()) { ?><a class="pin" href="<?php bloginfo("url") ?>/login" title="Login" rel="nofollow"></a><?php } ?>

  <a class="noText fb" href="javascript:fbShare('<?php the_permalink(); ?>', 'Compartir Arcor', 'Compartir Arcor', '<?php the_permalink(); ?>', 520, 350)">Compartir en Facebook</a>
  
  <a class="noText tw twitter" href="javascript:twShare('http://twitter.com/share?text=<?php the_title(); ?>', 'Compartir Arcor', 'Compartir Arcor', '<?php the_permalink(); ?>', 520, 350)">Compartir en Twitter</a>
