addLoadEvent(function () {
        ...
        function wpml_media_options_form_scan_prepare() {
            ...
            jQuery.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    wpml_update_status('wpml_media_options_form_scan_prepare:' + textStatus);
                }
        ...
        function wpml_media_set_initial_language() {
            ...
            if (jQuery('#set_language_info', form).is(':checked')) {
                jQuery.ajax({
                    ...
                    error: function (jqXHR, textStatus, errorThrown) {
                        wpml_update_status('wpml_media_set_initial_language:' + textStatus);
                    }
        ...
        function wpml_media_translate_media() {
            if (jQuery('#translate_media', form).is(':checked')) {
                jQuery.ajax({
                    ...
                    error: function (jqXHR, textStatus, errorThrown) {
                        wpml_update_status('wpml_media_translate_media:' + textStatus);
                    }
        ...
        function wpml_media_duplicate_media() {
            ...
            if (jQuery('#duplicate_media', form).is(':checked')) {
                jQuery.ajax({
                    ...
                    error: function (jqXHR, textStatus, errorThrown) {
                        wpml_update_status('wpml_media_duplicate_media:' + textStatus);
                    }
        ...
        function wpml_media_set_content_prepare() {
            ...
            jQuery.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    jQuery(form).find('.content_default_status').html(textStatus);
                }
            });
